export const CHAPTERS = [
  {
    ...
    duration: 3.2, handoffDuration: 4.0, finalExposure: 0.86,
  ...
  },
  {
    ...
    duration: 3.0, handoffDuration: 3.9, finalExposure: 0.82,
  ...
  },
  {
    ...
    duration: 3.2, handoffDuration: 4.1, finalExposure: 0.88,
  ...
  },
  {
    ...
    duration: 3.0, handoffDuration: 3.9, finalExposure: 0.84,
  ...
  },
  {
    ...
    kicker: "Result · 数据回望", title: "数据回望：用结果证明链路有效",
    body: "以下仍是版式占位数据，正式述职前必须替换为确认真实值。",
    layout: "metrics",
    items: [
      { value: "3,380万", label: "大盘有效交易额", note: "目标 3,300万 · 待替换" },
      { value: "78万", label: "线上毛利额", note: "目标 72万 · 待替换" },
      { value: "290万", label: "中腰部增长额", note: "目标 225万 · 待替换" },
      { value: "13.5%", label: "用户渗透率", note: "目标 13.2% · 待替换" },
      { value: "NPS 8", label: "体验指标", note: "目标 5 · 待替换" }
    ],
    duration: 3.2, handoffDuration: 4.0, finalExposure: 0.9,
  ...
  },
  {
    ...
    duration: 3.1, handoffDuration: 4.1, finalExposure: 0.86,
    context: { finalOpacity: 0.05, finalEmissiveIntensity: 0.012 },
    camera: {
